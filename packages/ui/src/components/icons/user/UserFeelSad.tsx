...
function SvgUserFeelSad ({ title, titleId }: SVGRProps): JSX.Element {
  return (
    <svg
    ...
    >
      ...
      <path
        clipRule='evenodd'
        d='M10.5 15.5a.5.5 0 00.5-.5 1 1 0 112 0 .5.5 0 101 0 2 2 0 00-4 0 .5.5 0 00.5.5z'
        fill='var(--icon-accent)'
        fillRule='evenodd'
      />
      <path
